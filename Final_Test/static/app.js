...
function buildCharts(STATE) {
  ...
  d3.json("/fires/"+STATE).then(function(fires){
    ...
    // console.log("FIRE YEAR" + FIRE_YEAR,
    //   "FIRE CAUSE" + FIRE_CAUSE,
    //   "FIRE SIZE" + FIRE_SIZE,
    //   "FIRE CAUSE LIST" + FIRE_CAUSE_LIST,
    //   "FIRE_CAUSE_COUNT" + FIRE_CAUSE_COUNT,
    //   "FIRE_YEAR_LIST" + FIRE_YEAR_LIST,
    //   "FIRE_YEAR_COUNT" + FIRE_YEAR_COUNT
    //   )
